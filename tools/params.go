...
func (paramsraw *ParamsRaw) Compile(option int, maxerror int) Params {
	var params Params
	if option == Gungnir_Three_Params {
		fmt.Println("Invalid Input option!")
		return params
	}
	...
	params.Penalty_upperbound = maxerror + 1
...
func (paramsraw *ParamsRaw) Compile_Three(maxerror int) Params {
	var params Params
	params.Option = Gungnir_Three_Params
	params.HashLen = paramsraw.HashLen
	params.PayloadLen = paramsraw.PayloadLen
